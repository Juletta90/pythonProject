...
# В созданный экземпляр класса передайте в качестве аргументов переменные
# quest_name, quest_description, quest_goal.
...
class Quest:
    ...
    def __str__(self):
        if self.end_time:  #т.е. если вычислено время окончания квеста - значит, он завершен
